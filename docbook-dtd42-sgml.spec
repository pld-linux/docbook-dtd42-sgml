%define ver	4.2
%define sver	42
Summary:	DocBook 4.2 SGML - DTD for technical documentation
Summary(pl.UTF-8):	DocBook 4.2 SGML - DTD przeznaczone do pisania dokumentacji technicznej
...
%description
DocBook 4.2 SGML - DTD for technical documentation.
...
ciekawych rzeczy. Ten pakiet zawiera wersję DocBook 4.2 SGML.
